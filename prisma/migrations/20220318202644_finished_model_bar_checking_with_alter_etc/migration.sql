/*
  ...
  - You are about to alter the column `height` on the `Avatar` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
  - You are about to alter the column `width` on the `Avatar` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
  - You are about to drop the column `updatedAt` on the `Login` table. All the data in the column will be lost.
  - You are about to alter the column `height` on the `Photo` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
  - You are about to alter the column `width` on the `Photo` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
...
INSERT INTO "new_User" ("birthday", "createdAt", "email", "firstName", "gender", "id", "lastName", "phoneNumber", "updatedAt", "userName") SELECT "birthday", "createdAt", "email", "firstName", "gender", "id", "lastName", "phoneNumber", "updatedAt", "userName" FROM "User";
DROP TABLE "User";
...
INSERT INTO "new_Comment" ("content", "createdAt", "id", "photoId", "userId") SELECT "content", "createdAt", "id", "photoId", "userId" FROM "Comment";
DROP TABLE "Comment";
